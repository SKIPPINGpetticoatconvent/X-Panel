...
func runUpgradeFlow() error {
	...
	// 4. 严格数据一致性检查
	log.Println("4. 严格数据一致性检查...")
	if err := database.StrictDataConsistencyCheck(); err != nil {
