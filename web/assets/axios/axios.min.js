...
!(function (e, t) {
	...
	var ce,
		...
		ye = {
			...
			isEmptyObject: function (e) {
				...
				try {
					return (
						0 === Object.keys(e).length && Object.getPrototypeOf(e) === Object.prototype
					);
				} catch (e) {
					return !1;
				}
	...
	var ct,
		...
		lt = function (e) {
			...
			if (
				...
				(n.url = Ae(
					at(n.baseURL, n.url, n.allowAbsoluteUrls),
					e.params,
					e.paramsSerializer,
				)),
				c &&
	...
	var At = function (e) {
		...
		Lt = function (e) {
			for (
				...
				var a = void 0;
				if (
					((r = t = e[i]), !Pt(t) && void 0 === (r = jt[(a = String(t)).toLowerCase()]))
				) {
	...
	(Ut.transitional = function (e, t, r) {
		function n(e, t) {
			return (
				"[Axios v1.11.0] Transitional option '" + e + "'" + t + (r ? ". " + r : "")
			);
		}
