  ...
  !function() {
    ...
    var e = function(t) {
          ...
          if (a = p[y], !e(a) && null !== a) {
            for (var g = 0; g < window.Object.keys(a).length; g++) {
              ...
              if (Object.prototype.hasOwnProperty.call(a, D)) {
                ...
                h = Array.isArray(u),
                  v && u && (r(u) || h)
                    ? (s = l[D], d = h && !Array.isArray(s) ? [] : h || r(s) ? s : {}, l[D] = o(v, d, u))
                    : e(u) || (l[D] = u);
              }
            }
          }
      ...
      d = function(t, n, e) {
        var i = s(n, e),
          ...
          h = i.month,
          d = i.day;
        return isNaN(u) || u < 1e3 || u > 1999 ? u = o.year : u < r.year ? u = r.year : u > a.year && (u = a.year),
          isNaN(h) || h < 1 || h > 12
            ? h = o.month
            : u <= r.year && h < r.month
            ? h = r.month
      ...
      p = function(t, n, e, i) {
        ...
        return o = r(o) ? s : l(t, { year: o.year, month: o.month, day: o.day }),
    ...
    var at,
          ...
          o = $("select", i, "change", function(n) {
            ...
            t.setValue(c(
              ...
              (i = {},
                ...
                a = n.target.value,
                o in i
                  ? Object.defineProperty(i, o, { value: a, enumerable: !0, configurable: !0, writable: !0 })
                  : i[o] = a,
                i),
            ));
          });
      ...
      dt = function(t, n, e) {
        $(
          E + (e
            ? t.options.maxDate.year === t.initDate.year ? ".".concat(Y) : ""
      ...
      ct = function(t, n, e) {
        $(
          O + (e
            ? t.options.minDate.year === t.initDate.year ? ".".concat(Y) : ""
              ...
              var o = function(n) {
                ...
                D = function(e) {
                  a.inBeforeMonth = a.day <= f && e < f,
                    ...
                    (a.inBeforeMonth || a.inAfterMonth) && (a.inBeforeMonth
                    ...
                    t.inputValue.day === a.day && t.inputValue.year === a.year && t.inputValue.month === a.month
                    && (a.className += ".".concat("selected")),
                    t.today.day === a.day && t.today.year === a.year && t.today.month === a.month
      ...
      lt = function(t) {
        ...
        t.options.date || !t.options.time || null !== (n = t.input) && void 0 !== n && n.value
        || $(N, e, z, function() {
          t.setValue(t.initTime), t.hide();
        }, "انتخاب"),
          t.options.showEmptyBtn && $(P, e, z, function() {
            t.input.value = "", Z(t.input, k), t.options.hideAfterChange && t.hide();
          }, "خالی"),
          t.options.showCloseBtn && $(V, e, z, function() {
            t.hide();
          }, "بستن");
      },
      yt = function(t) {
    ...
    var ft = /iphone|ipod|android|ie|blackberry|fennec/.test(
        null === (at = window.navigator) || void 0 === at || null === (rt = at.userAgent) || void 0 === rt
          ? void 0
          : rt.toLowerCase(),
      ),
      vt = {
        ...
        get today() {
          return this._today = this._today || this.options.today || function() {
            ...
            var r = o > 2 ? i + 1 : i;
            return n = 365 * i + parseInt((r + 3) / 4) - parseInt((r + 99) / 100) + parseInt((r + 399) / 400) - 80 + a
        ...
        get initDate() {
          return this.options.initDate
            ...
            : (this._initDate || (this._initDate = a(this.input.value) || {},
              r(this._initDate)
        ...
        get initTime() {
          ...
          return this._initTime = a(this.input.value) || this.options.initTime || n,
            o(this._initTime)
            && (f(this, this._initTime) ? this._initTime = m(this, this._initTime) : this._initTime = n),
        ...
        setValue: function(t) {
          ...
          this._value = s({
            ...
            this.input.value = (n = this,
              ...
              o = n.options.date
                ? "".concat(e.year).concat(i.date).concat(h(e.month)).concat(i.date).concat(h(e.day))
                : "",
              a = n.options.time
      ...
      Dt = function(t) {
        return !e(vt.options._date) && e(t.date) && (t.date = vt.options._date),
          ...
          window.Object.defineProperty(t, "date", {
            get: function() {
              var n, e;
              return !(null !== (n = vt.input) && void 0 !== n && n.hasAttribute(F))
                && (t._date || (null === (e = vt.input) || void 0 === e ? void 0 : e.hasAttribute(q)));
            },
            enumerable: !0,
          }),
          t._time = t.time,
          ...
          window.Object.defineProperty(t, "time", {
            get: function() {
              var n, e;
              return !(null !== (n = vt.input) && void 0 !== n && n.hasAttribute(q))
                && (t._time || (null === (e = vt.input) || void 0 === e ? void 0 : e.hasAttribute(F)));
            },
            enumerable: !0,
          }),
          t;
