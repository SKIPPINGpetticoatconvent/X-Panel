...
(function (r, x) {
	...
	return {
		best: function (k) {
			...
			for (q = 0; q < m && "" !== k[q]; q++);
			if (q < d) {
				for (k.splice(q, 1, "0000"); k.length < d; ) k.splice(q, 0, "0000");
			}
			for (q = 0; q < d; q++) {
				m = k[q].split("");
				for (var B = 0; 3 > B; B++) {
...
(function (r) {
	...
	function q(l) {
		return k(l, function (t) {
			var H = "";
			65535 < t &&
				((t -= 65536), (H += g(((t >>> 10) & 1023) | 55296)), (t = 56320 | (t & 1023)));
			return (H += g(t));
		}).join("");
	}
	function B(l, t, H) {
	...
	function z(l) {
		...
		0 > c && (c = 0);
		for (a = 0; a < c; ++a)
			128 <= l.charCodeAt(a) && x("not-basic"), t.push(l.charCodeAt(a));
		for (c = 0 < c ? c + 1 : 0; c < H; ) {
			a = y;
			var e = 1;
			for (b = 36; ; b += 36) {
	...
	function h(l) {
		...
		for ((t = H = I.length) && I.push("-"); t < M; ) {
			...
			var n = t + 1;
			f - a > v((2147483647 - b) / n) && x("overflow");
			b += (f - a) * n;
			a = f;
			for (y = 0; y < M; ++y) {
	...
	if (u.global === u || u.window === u || u.self === u) r = u;
	var J = /^xn--/,
		C = /[^\x20-\x7E]/,
		w = /[\x2E\u3002\uFF0E\uFF61]/g,
		G = {
	...
	var x = r && r.SecondLevelDomains,
		k = {
			...
			get: function (m) {
				...
				var B = k.list[m.slice(d + 1)];
				return !B || 0 > B.indexOf(" " + m.slice(q + 1, d) + " ")
					? null
					: m.slice(q + 1);
			},
			noConflict: function () {
...
(function (r, x) {
	...
	function h(a, b) {
		...
		for (e = a.length; f < e; f++)
			if ((c && void 0 !== c[a[f]]) || (!c && b.test(a[f]))) a.splice(f, 1), e--, f--;
		return a;
	}
	function p(a, b) {
		var c;
		...
		for (c = a.length; e < c; e++) {
			if ("RegExp" === f) {
				if ("string" === typeof a[e] && a[e].match(b)) return !0;
	...
	d.addQuery = function (a, b, c) {
		if ("object" === typeof b) {
			for (var e in b) A.call(b, e) && d.addQuery(a, e, b[e]);
	...
	d.setQuery = function (a, b, c) {
		if ("object" === typeof b) {
			for (var e in b) A.call(b, e) && d.setQuery(a, e, b[e]);
	...
	d.removeQuery = function (a, b, c) {
		...
		if (z(b)) {
			...
			for (e in b) A.call(b, e) && d.removeQuery(a, e, b[e]);
		} else if ("string" === typeof b) {
			void 0 !== c
				? "RegExp" === B(c)
					? !z(a[b]) && c.test(a[b])
	...
	d.hasQuery = function (a, b, c, e) {
		switch (B(b)) {
			...
			case "RegExp":
				for (var f in a)
					if (A.call(a, f) && b.test(f) && (void 0 === c || d.hasQuery(a, f, c)))
						return !0;
				return !1;
			case "Object":
	...
	d.joinPaths = function () {
		for (var a = [], b = [], c = 0, e = 0; e < arguments.length; e++) {
			...
			for (var n = 0; n < f.length; n++)
				"string" === typeof f[n] && b.push(f[n]), f[n] && c++;
		}
	...
	g.pathname = function (a, b) {
		if (void 0 === a || !0 === a) {
			return (
				(b = this._parts.path || (this._parts.hostname ? "/" : "")),
				a ? (this._parts.urn ? d.decodeUrnPath : d.decodePath)(b) : b
			);
		}
	...
	g.port = function (a, b) {
		...
		void 0 !== a &&
			(0 === a && (a = null),
			a &&
				((a += ""), ":" === a.charAt(0) && (a = a.substring(1)), d.ensureValidPort(a)));
	...
	g.origin = function (a, b) {
		...
		if (void 0 === a)
			return (
				(b = this.protocol()),
				this.authority() ? (b ? b + "://" : "") + this.authority() : ""
			);
		a = d(a);
	...
	g.userinfo = function (a, b) {
		if (this._parts.urn) return void 0 === a ? "" : this;
		if (void 0 === a)
			return (a = d.buildUserinfo(this._parts)) ? a.substring(0, a.length - 1) : a;
		"@" !== a[a.length - 1] && (a += "@");
	...
	g.domain = function (a, b) {
		...
		if (void 0 === a) {
			if (!this._parts.hostname || this.is("IP")) return "";
			if ((a = this._parts.hostname.match(/\./g)) && 2 > a.length)
	...
	g.suffix = function (a, b) {
		...
		c = this.suffix();
		if (c) {
			var e = a ? new RegExp(q(c) + "$") : new RegExp(q("." + c) + "$");
		} else {
			if (!a) return this;
	...
	g.segment = function (a, b, c) {
		...
		if (null === a || void 0 === f[a]) {
			if (z(b)) {
				...
				(b = u(b)), "" === f[f.length - 1] ? (f[f.length - 1] = b) : f.push(b);
	...
	g.segmentCoded = function (a, b, c) {
		...
		if (z(b)) {
			for (f = 0, e = b.length; f < e; f++) b[f] = d.encode(b[f]);
	...
	g.normalizePath = function (a) {
		...
		if (this._parts.urn)
			return (
				(this._parts.path = d.recodeUrnPath(this._parts.path)), this.build(!a), this
			);
	...
	g.readable = function () {
		...
		if (a._parts.query) {
			for (var c = "", e = 0, f = a._parts.query.split("&"), n = f.length; e < n; e++) {
				var E = (f[e] || "").split("=");
				c +=
					"&" + d.decodeQuery(E[0], this._parts.escapeQuerySpace).replace(/&/g, "%26");
				void 0 !== E[1] &&
					(c +=
						"=" +
						d.decodeQuery(E[1], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
			}
			b += "?" + c.substring(1);
		}
	...
	g.equals = function (a) {
		...
		b.query("");
		c.query("");
		if (b.toString() !== c.toString() || f.length !== n.length) return !1;
...
(function (r, x) {
	...
	k.expand = function (h, p, F) {
		...
		for (G = 0; (w = h[G]); G++) {
			...
			if (0 === v.type && F && F.strict) {
				throw Error('Missing expansion value for variable "' + w.name + '"');
			}
			if (v.val.length) {
	...
	k.expandUnnamed = function (h, p, F, u, J) {
		...
		for (v = h.val.length; g < v; g++) {
			if (J) {
				...
				G
					? ((A = r[w](h.val[g][1])),
						h[w].push([2 === h.type ? r[w](h.val[g][0]) : void 0, A]))
					: (A = h[w][g][1]);
			C && (C += u);
			if (2 === h.type) {
	...
	B.parse = function () {
		...
		for (p.lastIndex = 0; ; ) {
			...
			for (var A = 0, D = g.length; A < D; A++) {
				var l = g[A].match(F);
				if (null === l)
					throw Error('Invalid Variable "' + g[A] + '" in "' + v[0] + '"');
				if (l[1].match(u))
					throw Error('Invalid Variable Name "' + l[1] + '" in "' + v[0] + '"');
	...
	m.prototype.get = function (h) {
		var p = this.data,
			F = { type: 0, val: [], encode: [], encodeReserved: [] };
		if (void 0 !== this.cache[h]) return this.cache[h];
		this.cache[h] = F;
		p =
			"[object Function]" === String(Object.prototype.toString.call(p))
				? p(h)
		...
		if (void 0 !== p && null !== p) {
			if ("[object Array]" === String(Object.prototype.toString.call(p))) {
				...
				for (h = p.length; u < h; u++)
					void 0 !== p[u] && null !== p[u] && F.val.push([void 0, String(p[u])]);
