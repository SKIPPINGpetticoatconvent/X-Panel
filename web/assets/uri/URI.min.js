...
(function(r, x) {
  ...
  return {
    best: function(k) {
      ...
      var q;
      for (q = 0; q < m && "" !== k[q]; q++);
      if (q < d) { for (k.splice(q, 1, "0000"); k.length < d;) k.splice(q, 0, "0000"); }
      for (q = 0; q < d; q++) {
        m = k[q].split("");
        for (var B = 0; 3 > B; B++) {
          if ("0" === m[0] && 1 < m.length) m.splice(0, 1);
          else break;
        }
        k[q] = m.join("");
      }
...
(function(r) {
  ...
  function d(l) {
    for (var t = [], H = 0, y = l.length, I, M; H < y;) {
      I = l.charCodeAt(H++),
        55296 <= I && 56319 >= I && H < y
          ? (M = l.charCodeAt(H++),
            56320 == (M & 64512) ? t.push(((I & 1023) << 10) + (M & 1023) + 65536) : (t.push(I), H--))
          : t.push(I);
    }
    return t;
  }
  function q(l) {
    return k(l, function(t) {
      var H = "";
      65535 < t && (t -= 65536, H += g(t >>> 10 & 1023 | 55296), t = 56320 | t & 1023);
      return H += g(t);
    }).join("");
  }
  function B(l, t, H) {
  ...
  function z(l) {
    ...
    var c = l.lastIndexOf("-");
    0 > c && (c = 0);
    for (a = 0; a < c; ++a) 128 <= l.charCodeAt(a) && x("not-basic"), t.push(l.charCodeAt(a));
    for (c = 0 < c ? c + 1 : 0; c < H;) {
      a = y;
      var e = 1;
      for (b = 36;; b += 36) {
        ...
        (36 <= f || f > v((2147483647 - y) / e)) && x("overflow");
        y += f * e;
  ...
  function h(l) {
    ...
    for ((t = H = I.length) && I.push("-"); t < M;) {
      var f = 2147483647;
      for (y = 0; y < M; ++y) e = l[y], e >= a && e < f && (f = e);
      var n = t + 1;
      ...
      a = f;
      for (y = 0; y < M; ++y) {
        if (e = l[y], e < a && 2147483647 < ++b && x("overflow"), e == a) {
          var E = b;
          for (f = 36;; f += 36) {
            e = f <= c ? 1 : f >= c + 26 ? 26 : f - c;
            if (E < e) break;
            var K = E - e;
            E = 36 - e;
            var L = I;
            e += K % E;
            L.push.call(L, g(e + 22 + 75 * (26 > e) - 0));
            E = v(K / E);
          }
  ...
  var x = r && r.SecondLevelDomains,
    k = {
      ...
      has: function(m) {
        ...
        return B ? 0 <= B.indexOf(" " + m.slice(q + 1, d) + " ") : !1;
      },
      is: function(m) {
        var d = m.lastIndexOf(".");
        if (0 >= d || d >= m.length - 1 || 0 <= m.lastIndexOf(".", d - 1)) return !1;
        var q = k.list[m.slice(d + 1)];
        return q ? 0 <= q.indexOf(" " + m.slice(0, d) + " ") : !1;
      },
      get: function(m) {
        var d = m.lastIndexOf(".");
        ...
        var B = k.list[m.slice(d + 1)];
        return !B || 0 > B.indexOf(" " + m.slice(q + 1, d) + " ") ? null : m.slice(q + 1);
      },
      noConflict: function() {
        r.SecondLevelDomains === this && (r.SecondLevelDomains = x);
        return this;
      },
    };
  return k;
...
(function(r, x) {
  "object" === typeof module && module.exports
    ? module.exports = x(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains"))
    : "function" === typeof define && define.amd
    ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], x)
    : r.URI = x(r.punycode, r.IPv6, r.SecondLevelDomains, r);
})(this, function(r, x, k, m) {
  function d(a, b) {
  ...
  function h(a, b) {
    ...
    f = 0;
    for (e = a.length; f < e; f++) if (c && void 0 !== c[a[f]] || !c && b.test(a[f])) a.splice(f, 1), e--, f--;
    return a;
  }
  function p(a, b) {
    var c;
    if (z(b)) {
      var e = 0;
      for (c = b.length; e < c; e++) if (!p(a, b[e])) return !1;
      return !0;
    }
    var f = B(b);
    e = 0;
  ...
  d.leading_whitespace_expression = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/;
  ...
  var D = { encode: "encode", decode: "decode" },
    ...
    t = function(a, b) {
      return function(c) {
        try {
          return d[b](c + "").replace(d.characters[a][b].expression, function(e) {
            return d.characters[a][b].map[e];
          });
        } catch (e) {
          return c;
        }
  ...
  for (l in D) d[l + "PathSegment"] = t("pathname", D[l]), d[l + "UrnPathSegment"] = t("urnpath", D[l]);
  D = function(a, b, c) {
    return function(e) {
      var f = c
        ? function(K) {
        ...
        : d[b];
      e = (e + "").split(a);
      for (var n = 0, E = e.length; n < E; n++) e[n] = f(e[n]);
      return e.join(a);
    };
  };
  ...
  d.parse = function(a, b) {
    ...
    a = a.replace(/^[/\\]{2,}/i, "//");
    "//" === a.substring(0, 2)
      ? (b.protocol = null, a = a.substring(2), a = d.parseAuthority(a, b))
      : (c = a.indexOf(":"),
        -1 < c
        && (b.protocol = a.substring(0, c) || null,
          b.protocol && !b.protocol.match(d.protocol_expression) ? b.protocol = void 0 : "//"
              === a.substring(c + 1, c + 3).replace(/\\/g, "/")
  ...
  d.parseHost = function(a, b) {
    ...
    if ("[" === a.charAt(0)) {
      ...
      -1 !== f && (-1 === e || f < e)
        ...
        : (e = a.substring(0, c).split(":"), b.hostname = e[0] || null, b.port = e[1] || null);
    }
  ...
  d.parseUserinfo = function(a, b) {
    ...
    var e = a.indexOf("/"), f = a.lastIndexOf("@", -1 < e ? e : a.length - 1);
    -1 < f && (-1 === e
        || f < e)
      ? (a = a.substring(0, f).split(":"),
        b.username = a[0] ? d.decode(a[0]) : null,
        a.shift(),
        b.password = a[0] ? d.decode(a.join(":")) : null,
        a = c.substring(f + 1))
  ...
  d.build = function(a) {
    ...
    "string" === typeof a.path && ("/" !== a.path.charAt(0) && c && (b += "/"), b += a.path);
      ...
      if ("__proto__" !== f && A.call(a, f)) {
        if (z(a[f])) {
          ...
          for (n = a[f].length; K < n; K++) {
            void 0 !== a[f][K] && void 0 === E[a[f][K] + ""]
              && (e += "&" + d.buildQueryParameter(f, a[f][K], c),
                !0 !== b && (E[
                  a[f][K]
                  + ""
                ] = !0));
  ...
  d.addQuery = function(a, b, c) {
    if ("object" === typeof b) { for (var e in b) A.call(b, e) && d.addQuery(a, e, b[e]); }
    else if ("string" === typeof b) {
      void 0 === a[b]
        ? a[b] = c
        : ("string" === typeof a[b] && (a[b] = [a[b]]), z(c) || (c = [c]), a[b] = (a[b] || []).concat(c));
    } else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");
  };
  d.setQuery = function(a, b, c) {
    if ("object" === typeof b) { for (var e in b) A.call(b, e) && d.setQuery(a, e, b[e]); }
  ...
  d.removeQuery = function(a, b, c) {
    var e;
    if (z(b)) { for (c = 0, e = b.length; c < e; c++) a[b[c]] = void 0; }
    else if ("RegExp" === B(b)) { for (e in a) b.test(e) && (a[e] = void 0); }
    else if ("object" === typeof b) { for (e in b) A.call(b, e) && d.removeQuery(a, e, b[e]); }
    else if ("string" === typeof b) {
      void 0
          !== c
        ? "RegExp" === B(c)
          ? !z(a[b]) && c.test(a[b]) ? a[b] = void 0 : a[b] = h(a[b], c)
          : a[b] !== String(c) || z(c) && 1 !== c.length
          ? z(a[b]) && (a[b] = h(a[b], c))
          : a[b] = void 0
        : a[b] = void 0;
  ...
  d.hasQuery = function(a, b, c, e) {
    switch (B(b)) {
      case "String":
        break;
      case "RegExp":
        for (var f in a) if (A.call(a, f) && b.test(f) && (void 0 === c || d.hasQuery(a, f, c))) return !0;
        return !1;
      case "Object":
        for (var n in b) if (A.call(b, n) && !d.hasQuery(a, n, b[n])) return !1;
        return !0;
      default:
    ...
    switch (B(c)) {
      case "Undefined":
        return b in a;
      case "Boolean":
        return a = !(z(a[b]) ? !a[b].length : !a[b]), c === a;
      case "Function":
        return !!c(a[b], b, a);
      case "Array":
        return z(a[b]) ? (e ? p : F)(a[b], c) : !1;
      case "RegExp":
        return z(a[b]) ? e ? p(a[b], c) : !1 : !(!a[b] || !a[b].match(c));
      case "Number":
        c = String(c);
      case "String":
        return z(a[b]) ? e ? p(a[b], c) : !1 : a[b] === c;
      default:
        throw new TypeError(
  ...
  d.joinPaths = function() {
    for (var a = [], b = [], c = 0, e = 0; e < arguments.length; e++) {
      ...
      a.push(f);
      f = f.segment();
      for (var n = 0; n < f.length; n++) "string" === typeof f[n] && b.push(f[n]), f[n] && c++;
    }
  ...
  d.withinString = function(a, b, c) {
    ...
    for (e.lastIndex = 0;;) {
      ...
      N = -1 < O ? N.slice(0, O) + N.slice(O).replace(n, "") : N.replace(n, "");
      N.length <= L[0].length || c.ignore && c.ignore.test(N)
        || (O = P + N.length,
          L = b(N, P, O, a),
          void 0 === L
            ? e.lastIndex = O
            : (L = String(L), a = a.slice(0, P) + L + a.slice(O), e.lastIndex = P + L.length));
    }
    e.lastIndex = 0;
    return a;
  };
  d.ensureValidHostname = function(a, b) {
    ...
    if (a && a.match(d.invalid_hostname_characters)) {
      if (!r) {
        throw new TypeError(
          "Hostname \""
            + a + "\" contains characters other than [A-Z0-9.-:_] and Punycode.js is not available",
        );
      }
  ...
  d.noConflict = function(a) {
    if (a) {
      return a = { URI: this.noConflict() },
        m.URITemplate && "function" === typeof m.URITemplate.noConflict && (a.URITemplate = m.URITemplate.noConflict()),
        m.IPv6 && "function" === typeof m.IPv6.noConflict && (a.IPv6 = m.IPv6.noConflict()),
        m.SecondLevelDomains && "function" === typeof m.SecondLevelDomains.noConflict
        && (a.SecondLevelDomains = m.SecondLevelDomains.noConflict()),
        a;
    }
    m.URI === this && (m.URI = v);
    return this;
  ...
  g.pathname = function(a, b) {
    if (void 0 === a || !0 === a) {
      return b = this._parts.path || (this._parts.hostname ? "/" : ""),
        a
          ? (this._parts.urn
            ? d.decodeUrnPath
            : d.decodePath)(b)
  ...
  g.href = function(a, b) {
    ...
    var e = a instanceof d, f = "object" === typeof a && (a.hostname || a.path || a.pathname);
    ...
    if ("string" === typeof a || a instanceof String) this._parts = d.parse(String(a), this._parts);
      ...
      a = e ? a._parts : a;
      for (c in a) "query" !== c && A.call(this._parts, c) && (this._parts[c] = a[c]);
  ...
  g.is = function(a) {
    var b = !1, c = !1, e = !1, f = !1, n = !1, E = !1, K = !1, L = !this._parts.urn;
    this._parts.hostname
      && (L = !1,
        c = d.ip4_expression.test(this._parts.hostname),
        e = d.ip6_expression.test(this._parts.hostname),
        b = c || e,
        n = (f = !b) && k && k.has(this._parts.hostname),
        E = f && d.idn_expression.test(this._parts.hostname),
  ...
  g.protocol = function(a, b) {
    if (a && (a = a.replace(/:(\/\/)?$/, ""), !a.match(d.protocol_expression))) {
      throw new TypeError(
        "Protocol \"" + a + "\" contains characters other than [A-Z0-9.+-] or doesn't start with [A-Z]",
      );
    }
  ...
  g.port = function(a, b) {
    ...
    void 0 !== a
      && (0 === a && (a = null), a && (a += "", ":" === a.charAt(0) && (a = a.substring(1)), d.ensureValidPort(a)));
  ...
  g.origin = function(a, b) {
    if (this._parts.urn) return void 0 === a ? "" : this;
    if (void 0 === a) return b = this.protocol(), this.authority() ? (b ? b + "://" : "") + this.authority() : "";
    a = d(a);
    this.protocol(a.protocol()).authority(a.authority()).build(!b);
    return this;
  };
  g.host = function(a, b) {
    if (this._parts.urn) {
  ...
  g.userinfo = function(a, b) {
    if (this._parts.urn) return void 0 === a ? "" : this;
    if (void 0 === a) return (a = d.buildUserinfo(this._parts)) ? a.substring(0, a.length - 1) : a;
    "@" !== a[a.length - 1] && (a += "@");
  ...
  g.subdomain = function(a, b) {
    ...
    if (void 0 === a) {
      ...
      a = this._parts.hostname.length - this.domain().length - 1;
  ...
  g.domain = function(a, b) {
    ...
    if (void 0 === a) {
      if (!this._parts.hostname || this.is("IP")) return "";
      if ((a = this._parts.hostname.match(/\./g)) && 2 > a.length) return this._parts.hostname;
      b = this._parts.hostname.length - this.tld(b).length - 1;
      b = this._parts.hostname.lastIndexOf(".", b - 1) + 1;
    ...
    if (!this._parts.hostname || this.is("IP")) this._parts.hostname = a;
    else {
  ...
  g.directory = function(a, b) {
    ...
    if (void 0 === a || !0 === a) {
      ...
      b = this._parts.path.length - this.filename().length - 1;
      b = this._parts.path.substring(0, b) || (this._parts.hostname ? "/" : "");
      return a ? d.decodePath(b) : b;
    }
    var c = this._parts.path.length - this.filename().length;
    c = this._parts.path.substring(0, c);
    c = new RegExp("^" + q(c));
    this.is("relative") || (a ||= "/", "/" !== a.charAt(0) && (a = "/" + a));
    a && "/" !== a.charAt(a.length - 1) && (a += "/");
    a = d.recodePath(a);
  ...
  g.segment = function(a, b, c) {
    var e = this._parts.urn ? ":" : "/", f = this.path(), n = "/" === f.substring(0, 1);
    f = f.split(e);
      ...
      if (z(b)) {
        ...
        for (var E = b.length; a < E; a++) {
          if (b[a].length || f.length && f[f.length - 1].length) {
            f.length && !f[f.length - 1].length && f.pop(), f.push(u(b[a]));
          }
        }
      } else if (b || "string" === typeof b) b = u(b), "" === f[f.length - 1] ? f[f.length - 1] = b : f.push(b);
  ...
  g.segmentCoded = function(a, b, c) {
    ...
    if (z(b)) { for (f = 0, e = b.length; f < e; f++) b[f] = d.encode(b[f]); }
  ...
  g.query = function(a, b) {
    ...
    return void 0 !== a && "string" !== typeof a
      ? (this._parts.query = d.buildQuery(a, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace),
        this.build(!b),
        this)
      : M.call(this, a, b);
  };
  g.setQuery = function(a, b, c) {
    ...
    else if ("object" === typeof a) { for (var f in a) A.call(a, f) && (e[f] = a[f]); }
    else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");
  ...
  g.normalize = function() {
    return this._parts.urn
      ...
      : this.normalizeProtocol(!1).normalizeHostname(!1).normalizePort(!1).normalizePath(!1).normalizeQuery(!1)
        .normalizeFragment(!1).build();
  };
  g.normalizeProtocol = function(a) {
    "string" === typeof this._parts.protocol
      && (this._parts.protocol = this._parts.protocol.toLowerCase(), this.build(!a));
    return this;
  };
  g.normalizeHostname = function(a) {
    this._parts.hostname
      && (this.is("IDN") && r
        ...
        : this.is("IPv6") && x && (this._parts.hostname = x.best(this._parts.hostname)),
        this._parts.hostname = this._parts.hostname.toLowerCase(),
        this.build(!a));
    return this;
  };
  g.normalizePort = function(a) {
    "string" === typeof this._parts.protocol && this._parts.port === d.defaultPorts[this._parts.protocol]
  ...
  g.readable = function() {
    ...
    if (a._parts.query) {
      for (var c = "", e = 0, f = a._parts.query.split("&"), n = f.length; e < n; e++) {
        var E = (f[e] || "").split("=");
        c += "&" + d.decodeQuery(E[0], this._parts.escapeQuerySpace).replace(/&/g, "%26");
        void 0 !== E[1] && (c += "=" + d.decodeQuery(E[1], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
      }
      b += "?" + c.substring(1);
    }
  ...
  g.absoluteTo = function(a) {
    ...
    b._parts.path
      ? (".." === b._parts.path.substring(-2) && (b._parts.path += "/"),
        "/" !== b.path().charAt(0)
        && (c = (c = a.directory()) ? c : 0 === a.path().indexOf("/") ? "/" : "",
  ...
  g.relativeTo = function(a) {
    ...
    if (
      c.username === e.username && c.password === e.password && null === c.protocol && null === c.username
      && null === c.password
  ...
  g.equals = function(a) {
    ...
    for (e in b) {
      if (A.call(b, e)) {
        if (!z(b[e])) { if (b[e] !== n[e]) return !1; }
        else if (!F(b[e], n[e])) return !1;
        a[e] = !0;
      }
    }
...
(function(r, x) {
    ...
    for (G = 0; w = h[G]; G++) {
      ...
      if (v.val.length) {
        if (1 < v.type && w.maxlength) {
          throw Error("Invalid expression: Prefix modifier not applicable to variable \"" + w.name + "\"");
        }
        C.push(k["expand" + J](v, u, w.explode, w.explode && u.separator || ",", w.maxlength, w.name));
      } else v.type && C.push("");
    }
  ...
  k.expandNamed = function(h, p, F, u, J, C) {
    ...
    for (A = h.val.length; D < A; D++) {
      if (J) {
        ...
        2 === h.type && (g = r[G](h.val[D][0].substring(0, J)));
      } else {v
          ? (l = r[G](h.val[D][1]), 2 === h.type ? (g = r[G](h.val[D][0]), h[G].push([g, l])) : h[G].push([void 0, l]))
          : (l = h[G][D][1], 2 === h.type && (g = h[G][D][0]));}
      w && (w += u);
      F
        ? w += g + (p || l ? "=" : "") + l
        : (D || (w += r[G](C) + (p || l ? "=" : "")), 2 === h.type && (w += g + ","), w += l);
    }
    return w;
  };
  k.expandUnnamed = function(h, p, F, u, J) {
    ...
    for (v = h.val.length; g < v; g++) {
      if (J) { var A = r[w](h.val[g][1].substring(0, J)); }
      else G ? (A = r[w](h.val[g][1]), h[w].push([2 === h.type ? r[w](h.val[g][0]) : void 0, A])) : A = h[w][g][1];
      C && (C += u);
      if (2 === h.type) {
        var D = J ? r[w](h.val[g][0].substring(0, J)) : h[w][g][0];
        C += D;
        C = F ? C + (p || A ? "=" : "") : C + ",";
      }
      C += A;
  ...
  B.parse = function() {
    var h = this.expression,
      ...
      w = 0,
      G = function(t) {
        if (t.match(J)) throw Error("Invalid Literal \"" + t + "\"");
        return t;
      };
    for (p.lastIndex = 0;;) {
      var v = p.exec(h);
      ...
      if (!z[v[1]]) throw Error("Unknown Operator \"" + v[1] + "\" in \"" + v[0] + "\"");
      if (!v[3]) throw Error("Unclosed Expression \"" + v[0] + "\"");
      var g = v[2].split(",");
      for (
        var A = 0, D = g.length;
        A
        ...
        var l = g[A].match(F);
        if (null === l) throw Error("Invalid Variable \"" + g[A] + "\" in \"" + v[0] + "\"");
        if (l[1].match(u)) throw Error("Invalid Variable Name \"" + l[1] + "\" in \"" + v[0] + "\"");
        g[A] = { name: l[1], explode: !!l[3], maxlength: l[4] && parseInt(l[4], 10) };
      }
      if (!g.length) throw Error("Expression Missing Variable(s) \"" + v[0] + "\"");
      C.push({ expression: v[0], operator: v[1], variables: g });
    }
    C.length || C.push(G(h));
    this.parts = C;
    return this;
  ...
  m.prototype.get = function(h) {
    var p = this.data, F = { type: 0, val: [], encode: [], encodeReserved: [] };
    if (void 0 !== this.cache[h]) return this.cache[h];
    this.cache[h] = F;
    p = "[object Function]" === String(Object.prototype.toString.call(p))
      ? p(h)
      : "[object Function]" === String(Object.prototype.toString.call(p[h]))
      ? p[h](h)
      : p[h];
    if (void 0 !== p && null !== p) {
      if ("[object Array]" === String(Object.prototype.toString.call(p))) {
        var u = 0;
        for (h = p.length; u < h; u++) void 0 !== p[u] && null !== p[u] && F.val.push([void 0, String(p[u])]);
        F.val.length && (F.type = 3);
      } else if ("[object Object]" === String(Object.prototype.toString.call(p))) {
        for (u in p) q.call(p, u) && void 0 !== p[u] && null !== p[u] && F.val.push([u, String(p[u])]);
