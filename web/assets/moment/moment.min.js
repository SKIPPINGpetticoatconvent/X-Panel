!(function (e, t) {
	...
	function Nt(e) {
		var t,
			...
			i = e._i,
			r = e._f;
		if (((e._locale = e._locale || P(e._l)), null === i || (void 0 === r && "" === i)))
	...
	function an() {
		for (
			var e, t, n, s = [], i = [], r = [], a = [], o = this.eras(), u = 0, l = o.length;
			u < l;
			++u
		) {
			(e = f(o[u].name)),
		...
		(u.endOf = function (e) {
			...
			if (void 0 !== (e = o(e)) && "millisecond" !== e && this.isValid()) {
				switch (((n = this._isUTC ? sn : nn), e)) {
					...
					case "isoWeek":
						t =
							n(this.year(), this.month(), this.date() - (this.isoWeekday() - 1) + 7) -
							1;
						break;
					case "day":
					case "date":
					...
					case "hour":
						(t = this._d.valueOf()),
							(t +=
								36e5 - tn(t + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) - 1);
						break;
					case "minute":
	...
	(d.calendar = function (e, t, n) {
		...
		(d.monthsShort = function (e, t) {
			return e
				? (y(this._monthsShort)
						? this._monthsShort
						: this._monthsShort[Ve.test(t) ? "format" : "standalone"])[e.month()]
				: y(this._monthsShort)
					? this._monthsShort
